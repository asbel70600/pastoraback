...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/asbel/projects/pastora/back/public/storage' => 'string',
            ...
            'models.*.with_column_list' => 'boolean',
            ...
            'next-ide-helper.bootstrapper' => 'NULL',
            'next-ide-helper.aliases.file_name' => 'string',
            'next-ide-helper.models.directories' => 'array',
            'next-ide-helper.models.file_name' => 'string',
            'next-ide-helper.models.extensions' => 'array',
            'next-ide-helper.models.overrides' => 'array',
            'next-ide-helper.models.larastan_friendly' => 'boolean',
            'next-ide-helper.models.nullable_timestamps' => 'boolean',
            'next-ide-helper.macros.directories' => 'array',
            'next-ide-helper.macros.file_name' => 'string',
            'next-ide-helper.meta.file_name' => 'string',
            'next-ide-helper.factories.directories' => 'array',
            'next-ide-helper.factories.extensions' => 'array',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./home/asbel/projects/pastora/back/public/storage','logging.default',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','models.*.path',
'models.*.namespace','models.*.parent','models.*.use','models.*.connection','models.*.timestamps',
'models.*.soft_deletes','models.*.date_format','models.*.per_page','models.*.base_files','models.*.snake_attributes',
'models.*.indent_with_space','models.*.qualified_tables','models.*.hidden','models.*.guarded','models.*.casts.*_json',
'models.*.except','models.*.only','models.*.table_prefix','models.*.lower_table_name_first','models.*.model_names',
'models.*.relation_name_strategy','models.*.with_property_constants','models.*.with_column_list','models.*.pluralize','models.*.override_pluralize_for',
'models.*.hidden_in_base_files','models.*.fillable_in_base_files','models.*.enable_return_types','next-ide-helper.bootstrapper','next-ide-helper.aliases.file_name',
'next-ide-helper.models.directories','next-ide-helper.models.file_name','next-ide-helper.models.extensions','next-ide-helper.models.overrides','next-ide-helper.models.larastan_friendly',
'next-ide-helper.models.nullable_timestamps','next-ide-helper.macros.directories','next-ide-helper.macros.file_name','next-ide-helper.meta.file_name','next-ide-helper.factories.directories',
'next-ide-helper.factories.extensions','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'laravel-exceptions::minimal','next-ide-helper::meta','notifications::email','pagination::bootstrap-4','pagination::bootstrap-5',
